...
def repeat_string(text, num):
    ...
    #     print text
    # idk why they want an ugly version, but ok...
    print text * num
...
def write_letter(recipient, job_title, sender):
    # greeting = full_title(recipient, job_title)
    print "Dear {}, I think you are amazing! Sincerely, {}".format(full_title(recipient, job_title), sender)
